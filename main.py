...
def dark_matter_halos():
  ...
  print(""The idea of matter halos started with Fritz Zwicky in the 1930s. He saw that galaxies in the Coma Cluster moved too fast to be held by the visible mass and said there must be “dark matter.”\n
...
def extra_dimension_potential():
    ...
    # Print results
    print("\n--- Extra Dimension Potential Simulation ---")
    print(f"Density at r = {r_input}: Standard = {rho_std:.3f}, Extra Dimension = {rho_extra:.3f}")
  ...
  ("\nChoose an operation to perform on the Dark Matter Halo:")
    ...
    if choice == 2:
      ...
      velocities = velocity_dispersion_data()
    elif choice == 5:
